        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          <Card>
            ...
            <CardContent>
              ...
              <p>The domestic cat is a small, typically furry, carnivorous mammal. They are often called house cats when kept as indoor pets.</p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className="mb-4">There are many different cat breeds. Here are a few popular ones:</p>
